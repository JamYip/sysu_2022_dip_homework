...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache1 = conv_relu_pool_forward(
...
class ConvNet4(object):
    ...
    def __init__(
        ...
        C, H, W = input_dim
        self.params['W1'] = weight_scale * \
            np.random.randn(32, C, 7, 7)
        self.params['b1'] = np.zeros(32)
        
        self.params['W2'] = weight_scale * \
            np.random.randn(64, 32, 7, 7)
        self.params['b2'] = np.zeros(64)
        
        self.params['W3'] = weight_scale * \
            np.random.randn(64*(H//4)*(W//4), hidden_dim)
        self.params['b3'] = np.zeros(hidden_dim)
        
        self.params['W4'] = weight_scale * \
            np.random.randn(hidden_dim, num_classes)
    ...
    def loss(self, X, y=None):
        ...
        scores, cache2 = conv_relu_pool_forward(scores, W2, b2, conv_param, pool_param)
        scores, cache3 = affine_relu_forward(scores, W3, b3)
        scores, cache4 = affine_forward(scores, W4, b4)
